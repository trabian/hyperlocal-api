...
module.exports =
  ...
  fields: ["name", "nickname", "balance", "available_balance", "type", "transactions", "priority", "checking", "rate", "orig_loan_amt", "account_opened", "maturity_date", "due_date", "amount_due", "term", "urls"]
